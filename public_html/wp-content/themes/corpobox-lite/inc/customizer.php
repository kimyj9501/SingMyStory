...
#home-txt span, .page-header, .widget-title span { border-bottom-color: <?php echo esc_attr( get_theme_mod( 'corpobox_addit_color', '#333333' ) ); ?>; }
.single footer.entry-meta, cite { border-top-color: <?php echo esc_attr( get_theme_mod( 'corpobox_addit_color', '#333333' ) ); ?>; }
