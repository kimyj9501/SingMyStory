...
class KBFileHandler {
	 ...
	 */
	function upload($name, $extension=array(), $extension_type=1, $limit_file_size=20485760){
		...
		*/
		...
		if(count($extension)<=0 || !is_array($extension)){
			$extension = array('jpg', 'jpeg', 'gif', 'png', 'bmp', 'zip', '7z', 'hwp', 'ppt', 'xls', 'doc', 'txt', 'pdf', 'xlsx', 'pptx', 'docx','mp3');
		}
