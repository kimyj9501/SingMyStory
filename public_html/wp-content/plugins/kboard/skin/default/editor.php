<div id="kboard-default-editor">
	<form method="post" action="<?php echo $url->getContentEditorExecute()?>" enctype="multipart/form-data" onsubmit="return kboard_editor_execute(this);">
		...
		<input type="hidden" name="write" value="<?php echo $content->write?>">
		<input type="hidden" name="compose" value="<?php echo $content->compose?>">
		...
		<div class="kboard-attr-row">
			<label class="attr-name"><?php echo __('Write', 'kboard')?></label>
			<div class="attr-value"><input type="text" name="write" value="<?php echo $content->write?>"></div>
		</div>
		<div class="kboard-attr-row">
			<label class="attr-name"><?php echo __('Compose', 'kboard')?></label>
			<div class="attr-value"><input type="text" name="compose" value="<?php echo $content->compose?>"></div>
		</div>
