		...
		<table>
			<thead>
				<tr>
					...
					<td class="kboard-list-view"><?php echo __('View', 'kboard')?></td>
					<td class="kboard-list-write"><?php echo __('작사', 'kboard')?></td>
					<td class="kboard-list-compose"><?php echo __('작곡', 'kboard')?></td>
			...
			<tbody>
				...
				<tr class="kboard-list-notice">
					...
					<td class="kboard-list-write"><?php echo $content->write?></td>
					<td class="kboard-list-compose"><?php echo $content->compose?></td>
				...
				<tr>
					...
					<td class="kboard-list-date"><?php echo date("Y.m.d", strtotime($content->date))?></td>
					<td class="kboard-list-view"><?php echo $content->view?></td>
					<td class="kboard-list-write"><?php echo $content->category1?></td>
					<td class="kboard-list-compose"><?php echo $content->category2?></td>
				</tr>
