<div id="kboard-default-document">
	...
	<div class="kboard-document-wrap" itemscope itemtype="http://schema.org/Article">
		...
		<div class="kboard-detail">
			...
			<div class="detail-attr detail-write">
				<div class="detail-name"><?php echo __('Write', 'kboard')?></div>
				<div class="detail-value"><?php echo $content->write?></div>
			</div>
			<div class="detail-attr detail-compose">
				<div class="detail-name"><?php echo __('Compose', 'kboard')?></div>
				<div class="detail-value"><?php echo $content->compose?></div>
			</div>
		</div>
